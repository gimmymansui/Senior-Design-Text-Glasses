        ...
        window.tram = (function (t) {
          ...
          var s,
              ...
              return function a(s, u) {
                ...
                return (
                  ...
                  (c.open = function (t) {
                    if (
                      ((h = {}),
                      r(t) ? (h = t.call(c, d, f, c, s)) : i(t) && (h = t),
                      i(h))
                    )
            ...
            $ = function (t) {
              ...
              for (e = 0; e < z.length; e++)
                if ((n = z[e] + i) in L.style) return { dom: n, css: A[e] + t };
            },
            q = (e.support = {
          ...
          var S = (e.frame =
              (s =
                ...
                d.msRequestAnimationFrame) && q.bind
                ? s.bind(d)
                : function (t) {
                    d.setTimeout(t, 16);
                  }),
            j = (e.now =
              (c =
                (u = d.performance) &&
                (u.now || u.webkitNow || u.msNow || u.mozNow)) && q.bind
                ? c.bind(u)
                : Date.now ||
                  function () {
                    return +new Date();
            ...
            F = l(function (e) {
              ...
              (e.init = function (e) {
                ...
                q.backface &&
                  H.hideBackface &&
                  W(this.el, q.backface.css, "hidden");
              }),
                w("add", n),
                w("start", i),
                w("wait", function (t) {
                ...
                w("stop", s),
                w("set", function (t) {
                  s.call(this, t), h.call(this, t, d, v);
                }),
                w("show", function (t) {
            ...
            D = l(function (e) {
              function o() {
                var t,
                  ...
                  i = u.length;
                if (i)
                  for (S(o), e = j(), t = i; t--; ) (n = u[t]) && n.render(e);
              }
          ...
          var W = t.style,
            ...
            U = {
              ...
              "border-width": [N, g],
              "border-top-width": [N, g],
              "border-right-width": [N, g],
              "border-bottom-width": [N, g],
              "border-left-width": [N, g],
              "border-spacing": [N, g],
              "letter-spacing": [N, g],
              margin: [N, g],
              "margin-top": [N, g],
              ...
              "max-height": [N, y],
              "line-height": [N, k],
              "scroll-top": [C, w, "scrollTop"],
              "scroll-left": [C, w, "scrollLeft"],
            },
            Z = {};
          q.transform &&
            ((U.transform = [I]),
          ...
          (t.exports = function (t, e) {
            ...
            function p() {
              ...
              e.each(r, function (e) {
                ...
                if (e.active !== u) (e.active = u), v(i, h, u);
              });
            }
            function v(t, e, n) {
              var i = t.hasClass(e);
